...
/**
 * Die Klasse <b>Ausmultiplizieren</b> ist zum ausmultiplizieren der übergebenen Formel. Also es
 * geht hier um die Bildung der DNF.
 *
 * Diese Klasse ist genauso aufgebaut wie die Klasse "Ausaddieren". Es wurden nur die "* Zeichen"
...
public class Ausmultiplizieren {
    ...
    /**
     * Dies ist die Hauptmethode der Klasse "Ausmultiplizieren". Alles andere sind Hilfsmethoden.
     * Genaues funktionieren steht an den Codestellen selbst.
     * Diese Mehtode ruft sich rekursiv auf.
     *
     * @param formel übergebene Formel
     * @return Formel in DNF-Schreibweise
     */
    public static Formel ausmultiplizieren(Formel formel) {
         ...
         * In "block" stehen Variablen, welche UND-verknüpft sind.
         * In "innererBlock" stehen Variablen, ODER-verknüpft sind.
        ...
        /*
        ---------------------------------------------
        Unsere Struktur in "blockList" ist nun fertig aufgebaut und kann ausmultipliziert werden.
        ---------------------------------------------
         */


        //In "ergebnisBloecke" wird nach und nach unsere ausmultiplizierte Lösung eingefügt.
        //Das Ausmultiplizieren folgt nun.
        List<char[]> ergebnisBloecke = new ArrayList<>();

        //Der Check ist eingebaut, falls die Formel nur aus * Zeichen besteht. Dann geht das
        //ausmultiplizieren schneller und die untere IF zieht.
                ...
                for (b = b + 1; b < blockList.size() && keepGoing; b++) {
                    ...
                    for (int l = 0; l < innererBlock.size(); l++) {
                        ...
                        if (blockList.get(b).get(0)[0] == '*') {
                             ...
                             */
                        } else if (((b + 1 == blockList.size() && blockList.get(b - 1).get(0)[0] == '+')
                            ...
                            //da sie mit nichts multipiziert werden müssen.
                            if (blockList.get(b).get(0)[0] == '+') {
